	    ...
	    <ComponentCard title="List Project">
	    	<template #header-action>
	    		<div class="flex flex-col w-full gap-5 sm:justify-between xl:flex-row xl:items-center">	
			        ...
			        <button @click="createTagsModal = true" class="inline-flex items-center gap-2 rounded-full bg-brand-500 px-4 py-2.5 text-sm font-medium text-white shadow-theme-xs hover:bg-brand-600">
			          Tags
			          <Tags class="w-4 h-4" />
			        </button>
