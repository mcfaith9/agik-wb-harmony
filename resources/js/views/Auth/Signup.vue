          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            ...
            <div>
              <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
                <button
                  class="inline-flex items-center justify-center gap-2 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10">
                  <img class="w-4 h-4" src="@/images/brand/google.svg">
                  Sign up with Google
                </button>
                <button
                  ...
                  <img class="w-4 h-4" src="@/images/brand/github.svg">
                  Sign up with Github
                </button>
              </div>
                ...
                <div class="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                    />
                    <span v-if="errors.email" class="text-sm text-red-500 mt-1 block">
                      {{ errors.email[0] }}
                    </span>
                  </div>
                  <!-- Password -->
                  <div>
                    ...
                    <div class="relative">
                      ...
                      />
                      <span v-if="errors.password" class="text-sm text-red-500 mt-1 block">
                        {{ errors.password[0] }}
                      </span>
                      <span
          ...
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              ...
              <p class="text-center text-gray-400 dark:text-white/60">
                Collaborative app for managing tasks, communication, and teamwork.
              </p>
            </div>
          </div>
        </div>
