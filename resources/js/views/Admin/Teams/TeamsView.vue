<script setup>
  ...
  import CreateTeams from "@/views/Admin/Teams/CreateTeams.vue"
  import Teams from "@/views/Admin/Teams/Teams.vue"
  ...
  const addTeams = ref(false)
  const teamsTableRef = ref()
</script>
...
<template>
  <AdminLayout>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
      ...
      <div class="px-5 pb-6">
        <Teams ref="teamsTableRef" />
      </div>
    </div>

    <CreateTeams 
      :isOpen="addTeams" 
      @close="addTeams = false"
      @created="teamsTableRef?.refresh?.()" />
  </AdminLayout>
</template>
